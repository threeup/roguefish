...
#region TILE FUNCTIONS
	...
	static public int GridDistance(Vector2 a, Vector2 b)
	{
        ...
        return Mathf.Max(xDist, yDist); // For combat & abilities. Adjacent enemies are considered a distance of 1.
	}

	static public int BoundDistance(Actor a, Actor b)
	{
		Vector3 diff = a.gameObject.transform.position - b.gameObject.transform.position;
		return (int)diff.magnitude;
	}
