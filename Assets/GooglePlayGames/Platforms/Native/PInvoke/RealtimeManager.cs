...
internal class RealtimeManager {
    ...
    internal static void InternalLeaveRoomCallback(Status.ResponseStatus response, IntPtr data) {
        GoogLogger.d("Entering internal callback for InternalLeaveRoomCallback");
        ...
        try {
            ...
            GoogLogger.e("Error encountered executing InternalLeaveRoomCallback. " +
    ...
    internal static void InternalSendReliableMessageCallback(Status.MultiplayerStatus response,
        IntPtr data) {
        GoogLogger.d("Entering internal callback for InternalSendReliableMessageCallback " + response);
        ...
        try {
            ...
            GoogLogger.e("Error encountered executing InternalSendReliableMessageCallback. " +
                "Smothering to avoid passing exception into Native: " + e);
        }
    }
